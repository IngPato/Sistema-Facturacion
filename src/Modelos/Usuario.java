...
public class Usuario {
    ...
    // Usuario que ha iniciado sesión (usuario actual en memoria)
    ...
    // Método para obtener el usuario actual desde cualquier clase
    ...
    public static Usuario verificarCredenciales(String nombreUsuario, String contraseña) {
        ...
        try {
            conn = BaseDatos.conectar(); // METODO DE BASE DE DATOS
